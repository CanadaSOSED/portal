...
<tbody>
    ...
    <tr>
        <td align="center" valign="top" style="padding-bottom:35px;padding-left:20px;padding-right:20px" class="subTitle">
            <p style="font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:24px;text-align:center;padding:0;margin:10px;"><?php echo $user_message; ?></p></td>
    </tr>
    <tr>
