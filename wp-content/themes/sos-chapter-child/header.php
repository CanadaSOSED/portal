...
<!--					<span class="accInfo" style="font-size:10pt; color: #fff;"><a href="<?php bloginfo('site_url'); ?>/my-account">Login</a> | <a href="<?php bloginfo('site_url'); ?>/my-account">Register</a></span> <!--You're gonna have to figure out how to change this when logged in-->
