...
- <strong>WC Marketplace</strong> - [Overview](https://youtu.be/uZDU8NLeTb8) - [Documentation](http://wclovers.com/documentation/wcfm-wc-marketplace/) - [Demo](http://wcmp.wclovers.com/my-account/)
- <strong>WC Vendors</strong> - [Overview](https://youtu.be/efB2_UY49zI) - [Documentation](http://wclovers.com/documentation/wcfm-wc-vendors/) - [Demo](http://wcvendors.wclovers.com/my-account/)
- <strong>WooCommerce Product Vendors</strong> - [Overview](https://youtu.be/vSK0rS4Dm_0) - [Documentation](http://wclovers.com/documentation/wcfm-wc-product-vendors/) - [Demo](http://wcpvendors.wclovers.com/my-account/)

= Booking Compatibility =

Exclusively integrated with <strong>WooCommerce Bookings</strong> -

- <strong>WC Bookings</strong> - [Overview](https://youtu.be/PqSm6jO6bPY) - [Documentation](http://wclovers.com/documentation/wcfm-wc-booking/) - [Demo](http://wcbooking.wclovers.com/my-account/)

[youtube https://youtu.be/gitvRdLMTjw]
...
* Feature - YITH Auctions integrated
* Feature - WooCommerce Rental & Booking integrated
...
= 2.3.5 =
* Feature - WooCommerce Bulk Discount integrated
* Feature - WooCommerce Product Fees integrated

= 2.3.4 =
* Feature - WP Job Manager - WC Paid Listing integrated
* Feature - WP Job Manager - Resume Manager integrated
* Enhance - Messaging action integrated

= 2.3.3 =
* Enhance - WC Marketplace Knowledgebase integrated
...
* Feature - GEO my WordPress integrated
...
= 2.2.4 =
* Feature - WooCommerce PDF Invoices & Packing Slips integrated
