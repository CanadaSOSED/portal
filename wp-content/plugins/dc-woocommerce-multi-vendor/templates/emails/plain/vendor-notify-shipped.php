...
global $WCMp;
echo $email_heading . "\n\n";
echo sprintf( __( 'Some of the items you had ordered have been shipped. The items that have been shipped are as follows:',  $WCMp->text_domain ), $order->get_billing_first_name() . ' ' . $order->get_billing_last_name() ) . "\n\n";
