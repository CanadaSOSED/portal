            ...
            "sections" => array(
                "venor_approval_settings_section" => array("title" => '', // Section one
                    "fields" => apply_filters('wcmp_general_tab_filds', array(
                        "enable_registration" => array('title' => __('Vendor Registration', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'enable_registration', 'label_for' => 'enable_registration', 'text' => __('Anyone can register as vendor. Leave it unchecked if you want to keep your site an invite only marketpace.', $WCMp->text_domain), 'name' => 'enable_registration', 'value' => 'Enable'), // Checkbox
                        "approve_vendor_manually" => array('title' => __('Approve Vendors Manually', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'approve_vendor_manually', 'label_for' => 'approve_vendor_manually', 'text' => __('If left unchecked, every vendor applicant will be auto-approved, which is not a recommended setting.', $WCMp->text_domain), 'name' => 'approve_vendor_manually', 'value' => 'Enable'), // Checkbox
                        "is_backend_diabled" => apply_filters('is_wcmp_backend_disabled',array('title' => __('Disallow vendors wp-admin access', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'is_backend_diabled', 'custom_tags'=> array('disabled' => 'disabled'), 'label_for' => 'is_backend_diabled', 'text' => __('Get the <a href="https://wc-marketplace.com/product/wcmp-frontend-manager/">Front-end manager</a> to offer a single dashboard for all vendor purpose and eliminate their backend access requirement.', $WCMp->text_domain), 'name' => 'is_backend_diabled', 'value' => 'Enable', 'hints' => __('If unchecked vendor will have access of backend'))) , // Checkbox
//                        "notify_configure_vendor_store" => array('title' => __('Add Vendor Notify Section', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'notify_configure_vendor_store', 'label_for' => 'notify_configure_vendor_store', 'text' => __('Add a section in the vendor dashboard to notify vendors if they have not configured stores properly.', $WCMp->text_domain), 'name' => 'notify_configure_vendor_store', 'value' => 'Enable'), // Checkbox
                        "is_university_on" => array('title' => __('Vendor Knowledgebase', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'is_university_on', 'label_for' => 'is_university_on', 'name' => 'is_university_on', 'value' => 'Enable', 'text' => __('Enable "Knowledgebase" section on vendor dashboard.', $WCMp->text_domain)), // Checkbox
                        "is_singleproductmultiseller" => array('title' => __('Single Product Multiple Vendors', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'is_singleproductmultiseller', 'label_for' => 'is_singleproductmultiseller', 'name' => 'is_singleproductmultiseller', 'value' => 'Enable', 'text' => __('Allow multiple vendors to sell same product. Buyers can choose their preffered vendor.',$WCMp->text_domain)), // Checkbox
                        "is_sellerreview" => array('title' => __('Enable Vendor Review', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'is_sellerreview', 'label_for' => 'is_sellerreview', 'name' => 'is_sellerreview', 'value' => 'Enable', 'text' => __('Buyers can rate and review vendor.', $WCMp->text_domain)), // Checkbox  
                        "is_sellerreview_varified" => array('title' => __('', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'is_sellerreview_varified', 'label_for' => 'is_sellerreview_varified', 'name' => 'is_sellerreview_varified', 'value' => 'Enable', 'text' => __('Only buyers, purchased from the vendor can rate.', $WCMp->text_domain)), // Checkbox 
                        "is_policy_on" => array('title' => __('Enable Policies ', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'is_policy_on', 'label_for' => 'is_policy_on', 'name' => 'is_policy_on', 'value' => 'Enable', 'text' => __('If enabled a policy section will be added to single product page', $WCMp->text_domain)), // Checkbox
                        "is_customer_support_details" => array('title' => __('Enable Customer Support', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'is_customer_support_details', 'label_for' => 'is_customer_support_details', 'name' => 'is_customer_support_details', 'value' => 'Enable', 'text' => __('Show support channel details in "Thank You" page and new order email.', $WCMp->text_domain)), // Checkbox
                        )
                    ),
                ),
            ),
