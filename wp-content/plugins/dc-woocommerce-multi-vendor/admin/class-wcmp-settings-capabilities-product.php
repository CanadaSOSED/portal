                ...
                "products_capability" => array(
                  "title" => __('Products Capability', 'dc-woocommerce-multi-vendor'),
                    "fields" => array(
                        ...
                        "is_edit_delete_published_product" => array('title' => __('Edit Publish Products', 'dc-woocommerce-multi-vendor'), 'type' => 'checkbox', 'id' => 'is_edit_delete_published_product', 'label_for' => 'is_edit_delete_published_product', 'name' => 'is_edit_delete_published_product', 'text' => __('Allow vendors to Edid published products.', 'dc-woocommerce-multi-vendor'), 'value' => 'Enable'), // Checkbox
