	...
	class LearnDash_Settings_Courses_Taxonomies extends LearnDash_Settings_Section {
		...
		protected function __construct() {
			...
			$this->settings_section_description = sprintf(
				wp_kses_post(
					// translators: placeholder: Course.
					_x( '<p>Control which Taxonomies can be used with the LearnDash %s.</p>', 'placeholder: Course', 'learndash' ) ), LearnDash_Custom_Label::get_label( 'course' ) );
		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				'ld_course_category' => array(
					...
					'label' => sprintf(
						// translators: placeholder: Course.
						esc_html_x( 'LearnDash %s Categories', 'placeholder: Course', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'course' )
					),
					'help_text' => sprintf(
						// translators: placeholder: Course.
						esc_html_x( 'Enable the builtin LearnDash %s Categories', 'placeholder: Course', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) ),
				...
				'ld_course_tag' => array(
					...
					'label' => sprintf(
						// translators: placeholder: Course.
						esc_html_x( 'LearnDash %s Tags', 'placeholder: Course', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'course' )
					),
					'help_text' => sprintf(
						// translators: placeholder: Course.
						esc_html_x( 'Enable the builtin LearnDash %s Tags', 'placeholder: Course', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'course' )
					),
