	...
	class LearnDash_Settings_Quizzes_Builder extends LearnDash_Settings_Section {
		...
		protected function __construct() {
			...
			if ( true !== is_data_upgrade_quiz_questions_updated() ) {
				...
				$this->settings_section_description = '<span class="error">' . sprintf(
		...
		public function load_settings_fields() {
			$this->setting_option_fields = array(
				'enabled' => array(
					...
					'help_text' => sprintf(
						// translators: placeholder: Quiz.
						esc_html_x( 'Enable %s Builder Interface', 'placeholder: Quiz', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'quiz' )
					),
				...
				'shared_questions' => array(
					...
					'desc_before' => sprintf(
						wp_kses_post(
							...
							_x( '<p>Enables using %1$s across multiple %2$s.</p>', 'placeholder: Questions, Quizzes', 'learndash' )
						),
						LearnDash_Custom_Label::get_label( 'questions' ),
					...
					'help_text' => sprintf(
						// translators: placeholder: Questions, Quizzes.
						esc_html_x( 'Use %1$s across multiple %2$s', 'placeholder: Questions, Quizzes', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'questions' ),
						LearnDash_Custom_Label::get_label( 'quizzes' )
					),
