	...
	class LearnDash_Settings_Topics_Taxonomies extends LearnDash_Settings_Section {
		...
		protected function __construct() {
			...
			$this->settings_section_description = sprintf(
				wp_kses_post(
					// translators: placeholder: Topic.
					_x( '<p>Control which Taxonomies can be used with the LearnDash %s.</p>', 'placeholder: Topics', 'learndash' )
				),
		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				'ld_topic_category' => array(
					...
					'label' => sprintf(
						// translators: placeholder: Topic.
						esc_html_x( 'LearnDash %s Categories', 'placeholder: Topic', 'learndash' ), 
						LearnDash_Custom_Label::get_label( 'topic' )
					),
					'help_text' => sprintf(
						// translators: placeholder: Topic.
						esc_html_x( 'Enable the builtin LearnDash %s Categories', 'placeholder: Topic', 'learndash' ), 
						LearnDash_Custom_Label::get_label( 'topic' )
					),
				...
				'ld_topic_tag' => array(
					...
					'label' => sprintf(
						// translators: placeholder: Topic.
						esc_html_x( 'LearnDash %s Tags', 'placeholder: Topic', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'topic' )
					),
					'help_text' => sprintf(
						// translators: placeholder: Topic.
						esc_html_x( 'Enable the builtin LearnDash %s Tags', 'placeholder: Topic', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'topic' )
					),
