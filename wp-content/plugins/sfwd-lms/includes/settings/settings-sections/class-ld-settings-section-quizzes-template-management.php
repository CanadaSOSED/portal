	...
	class LearnDash_Settings_Quizzes_Template_Management extends LearnDash_Settings_Section {
		...
		protected function __construct() {
			...
			$this->settings_section_label = sprintf(
				...
				esc_html_x( '%s Template Management', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' )
			);
		...
		public function load_settings_fields() {
			$this->setting_option_fields = array(
				'quiz_template' => array(
					...
					'help_text' => sprintf(
						// translators: placeholder: Quiz.
						esc_html_x( 'Manage %s templates. Select a template then update the title or delete.', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' )
					),
					'value'     => '',
