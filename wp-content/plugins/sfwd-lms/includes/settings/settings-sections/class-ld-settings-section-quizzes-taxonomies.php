	...
	class LearnDash_Settings_Quizzes_Taxonomies extends LearnDash_Settings_Section {
		...
		protected function __construct() {
			...
			$this->settings_section_description = sprintf(
				wp_kses_post(
					// translators: placeholder: Qizzes.
					_x( '<p>Control which Taxonomies can be used with the LearnDash %s.</p>', 'placeholder: Quizzes', 'learndash' )
				),
		...
		public function load_settings_values() {
			...
			if ( false === $this->setting_option_values ) {
				...
				if ( $ld_prior_version == 'new' ) {
					$this->setting_option_values['ld_quiz_category'] = 'yes';
					$this->setting_option_values['ld_quiz_tag'] = 'yes';
		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				'ld_quiz_category' => array(
					...
					'label' => sprintf(
						// translators: placeholder: Quiz.
						esc_html_x( 'LearnDash %s Categories', 'placeholder: Quiz', 'learndash' ), 
						LearnDash_Custom_Label::get_label( 'quiz' )
					),
					'help_text' => sprintf(
						// translators: placeholder: Quiz.
						esc_html_x( 'Enable the builtin LearnDash %s Categories', 'placeholder: Quiz', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'quiz' )
					),
				...
				'ld_quiz_tag' => array(
					...
					'label' => sprintf(
						// translators: placeholder: Quiz.
						esc_html_x( 'LearnDash %s Tags', 'placeholder: Quiz', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'quiz' )
					),
					'help_text' => sprintf(
						// translators: placeholder: Quiz.
						esc_html_x( 'Enable the builtin LearnDash %s Tags', 'placeholder: Quiz', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'quiz' )
					),
