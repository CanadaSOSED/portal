		...
		protected function __construct() {
			...
			$this->settings_section_description = sprintf(
				wp_kses_post(
					...
					_x( '<p>Control which Taxonomies can be used with the LearnDash %s.</p>', 'placeholder: Lessons', 'learndash' ) ), LearnDash_Custom_Label::get_label( 'lessons' ) );
		...
		public function load_settings_fields() {
			...
			$this->setting_option_fields = array(
				'ld_lesson_category' => array(
					...
					'label' => sprintf(
						// translators: placeholder: Lesson.
						esc_html_x( 'LearnDash %s Categories', 'placeholder: Lesson', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'lesson' )
					),
					'help_text' => sprintf(
						// translators: placeholder: Lesson.
						esc_html_x( 'Enable the builtin LearnDash %s Categories', 'placeholder: Lesson', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'lesson' )
					),
				...
				'ld_lesson_tag' => array(
					...
					'label' => sprintf(
						// translators: placeholder: Lesson.
						esc_html_x( 'LearnDash %s Tags', 'placeholder: Lesson', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'lesson' )
					),
					'help_text' => sprintf(
						// translators: placeholder: Lesson.
						esc_html_x( 'Enable the builtin LearnDash %s Tags', 'placeholder: Lesson', 'learndash' ),
						LearnDash_Custom_Label::get_label( 'lesson' ) 
					),
