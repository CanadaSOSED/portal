<?php
if ( ( class_exists( 'LearnDash_Settings_Section_Fields' ) ) && ( !class_exists( 'LearnDash_Settings_Section_Fields_Hidden' ) ) ) {
	class LearnDash_Settings_Section_Fields_Hidden extends LearnDash_Settings_Section_Fields {
...
add_action( 'learndash_settings_sections_fields_init', function() {
	LearnDash_Settings_Section_Fields_Hidden::add_field_instance('hidden');
} );
