...
if ( ( class_exists( 'LearnDash_Settings_Section_Fields' ) ) && ( ! class_exists( 'LearnDash_Settings_Section_Fields_Select_Edit_Delete' ) ) ) {
	/**
	 * Class to create the settings field.
	 */
	class LearnDash_Settings_Section_Fields_Select_Edit_Delete extends LearnDash_Settings_Section_Fields {
...
add_action( 'learndash_settings_sections_fields_init', function() {
	LearnDash_Settings_Section_Fields_Select_Edit_Delete::add_field_instance( 'select-edit-delete' );
} );
