	...
	abstract class LearnDash_Settings_Page {
		...
		public function load_settings_page() {
			...
			wp_enqueue_style(
				...
				LEARNDASH_LMS_PLUGIN_URL . 'assets/css/learndash-admin-settings-page' . ( ( defined( 'LEARNDASH_SCRIPT_DEBUG' ) && ( LEARNDASH_SCRIPT_DEBUG === true ) ) ? '' : '.min' ) . '.css',
				array(),
				LEARNDASH_SCRIPT_VERSION_TOKEN
			);
		...
		public function screen_layout_column( $columns = false, $screen_id = '' ) {
			 ...
			 * @since 2.6.0
			 */
			add_filter( "get_user_option_screen_layout_{$screen_id}", function( $option_value = '', $option_key = '' ) {
