		...
		<div class="wrap wpProQuiz_quizEdit">
			<table class="form-table">
				<tbody>
					<tr>
						<th scope="row">
							<?php echo sprintf( esc_html_x('Hide %s title', 'Hide quiz title', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
						</th>
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('The title serves as %s heading.', 'The title serves as quiz heading.', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
								</p>
							</fieldset>
						</td>
					</tr>
					<tr>
						<th scope="row">
							<?php echo sprintf( esc_html_x('Hide "Restart %s" button', 'Hide "Restart quiz" button', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
						</th>
						<td>
							<fieldset>
								<legend class="screen-reader-text">
									<span><?php echo sprintf( esc_html_x('Hide "Restart %s" button', 'Hide "Restart quiz" button', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></span>
								</legend>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('Hide the "Restart %s" button in the Frontend.', 'Hide the "Restart quiz" button in the Frontend.', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
							</fieldset>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('Statistics about right or wrong answers. Statistics will be saved by completed %s, not after every question. The statistics is only visible over administration menu. (internal statistics)', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
							</fieldset>
						</td>
					</tr>
					...
					<tr id="statistics_show_profile_tr" style="display: none;">
						...
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('Enable user to view statistics for this %s on their profile.', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
							</fieldset>
						</td>
					</tr>
					...
					<tr>
						<th scope="row">
							<?php echo sprintf( esc_html_x('Execute %s only once', 'Execute quiz only once', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
						</th>
						<td>
							<fieldset>
							
								<legend class="screen-reader-text">
									<span><?php echo sprintf( esc_html_x('Execute %s only once', 'Execute quiz only once', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></span>
								</legend>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('If you activate this option, the user can complete the %1$s only once. Afterwards the %2$s is blocked for this user.', 'placeholders: quiz, quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('If you enable this option, you can choose %1$s, which user have to finish before he can start this %2$s.', 'placeholders: quiz, quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
								<p class="description">
									<?php echo sprintf( esc_html_x('In all selected %s statistic function have to be active. If it is not it will be activated automatically.', 'placeholders: quizzes', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ); ?>
								</p>
								<div id="prerequisiteBox" style="display: none;">
									<table id="learndash-prerequisite-table">
										<tr>
											...
											<th class="learndash-quiz-prerequisite-list learndash-quiz-prerequisite-list-right"><?php echo sprintf( esc_html_x('Prerequisites (This %s has to be finished)', 'Prerequisites (This quiz has to be finished)', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></th>
										</tr>
										<tr>
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('Additional %s overview will be displayed, before %s is finished.', 'placeholders: quiz, quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
								</p>
								<div class="wpProQuiz_demoBox">
									<?php esc_html_e('Question overview', 'learndash'); ?>: <a href="#"><?php esc_html_e('Demo', 'learndash'); ?></a>
								...
								<div class="wpProQuiz_demoBox">
									<?php echo sprintf( esc_html_x( '%s-summary', 'Quiz-summary', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?>: <a href="#"><?php esc_html_e('Demo', 'learndash'); ?></a>
									<div style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
					...
					<tr class="wpProQuiz_reviewQuestionOptions" style="display: none;">
						...
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('If you enable this option, no %1$s overview will be displayed, before finishing %2$s.', 'placeholders: quiz, quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
							</fieldset>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('If you enable this option, you will be informed if a user completes this %s.', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
								<p class="description">
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('If you enable this option, an email is sent with his %s result to the user. (only registered users)', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'course' ) ); ?>
								</p>
								<p class="description">
									<?php esc_html_e('E-Mail settings can be edited in global settings.', 'learndash'); ?>
								</p>
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('If you enable this option, the %s will start automatically after the page is loaded.', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
							</fieldset>
						</td>
					</tr>
					<tr>
						<th scope="row">
							<?php echo sprintf( esc_html_x('Only registered users are allowed to start the %s', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
						</th>
						<td>
							<fieldset>
								<legend class="screen-reader-text">
									<span><?php echo sprintf( esc_html_x('Only registered users are allowed to start the %s', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></span>
								</legend>
								<label>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('If you enable this option, only registered users allowed start the %s.', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
							</fieldset>
						</td>
					</tr>
		...
		<div class="wrap wpProQuiz_quizEdit">
			<table class="form-table">
				<tbody>
					<tr>
						...
						<td>
							<fieldset>
								...
								<div class="wpProQuiz_demoBox">
									<a href="#"><?php esc_html_e('Demo', 'learndash'); ?></a>
									<div style="z-index: 9999999; position: absolute; background-color: #E9E9E9; padding: 10px; box-shadow: 0px 0px 10px 4px rgb(44, 44, 44); display: none; ">
					...
					<tr>
						<th scope="row">
							<?php echo sprintf( esc_html_x('Hide %s time - display', 'Hide quiz time - display', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
						</th>
						<td>
							<fieldset>
								<legend class="screen-reader-text">
									<span><?php echo sprintf( esc_html_x('Hide %s time - display', 'Hide quiz time - display', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></span>
								</legend>
								<label>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('If you enable this option, the time for finishing the %s won\'t be displayed on the results page anymore.', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								</p>
							</fieldset>
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<p class="description">
									<?php echo sprintf( esc_html_x('Shows in %s, how many points are reachable for respective question.', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
								</p>
							</fieldset>
						</td>
					</tr>
			...
			<table class="form-table">
				<tbody id="toplistBox">
					...
					<tr id="AutomaticallyDisplayLeaderboard">
						<th scope="row">
							<?php echo sprintf( esc_html_x('Automatically display leaderboard in %s result', 'Automatically display leaderboard in quiz result', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
						</th>
						<td>
...
.wpProQuiz_quizModus th, .wpProQuiz_quizModus td {
		...
		<div class="wrap wpProQuiz_quizEdit">
			<table style="width: 100%; border-collapse: collapse; border: 1px solid #A0A0A0;" class="wpProQuiz_quizModus">
				...
				<tbody>
					...
					<tr>
						<td>
							<?php echo sprintf( esc_html_x('Displays all questions sequentially, "right" or "false" will be displayed at the end of the %s.', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
						</td>
						<td>
						...
						<td>
							<fieldset>
								...
								<label>
									...
									<?php echo sprintf( esc_html_x('On the %s startpage', 'On the quiz startpage', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
								...
								<label>
									...
									<?php echo sprintf( esc_html_x('At the end of the %s (before the %s result)', 'At the end of the quiz (before the quiz result)', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
	...
	public function resultText() {
		...
		<div class="wrap wpProQuiz_quizEdit">
			...
			<div class="inside">
				<p class="description">
					<?php echo sprintf( esc_html_x('This text will be displayed at the end of the %s (in results). (this text is optional)', 'placeholders: quiz', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?>
				</p>
				...
				<div style="display: none;" id="resultGrade">
					<div>
						...
						<ul style="list-style-type: square; padding: 5px; margin-left: 20px; margin-top: 0;">
							...
							<li>
								<?php echo sprintf( esc_html_x('Percentages refer to the total score of the %1$s. (Current total %2d points in %3$d questions.', 'placeholders: quiz, question points, question count', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), $this->quiz->fetchSumQuestionPoints(), $this->quiz->fetchCountQuestions()); ?>
								</li>
