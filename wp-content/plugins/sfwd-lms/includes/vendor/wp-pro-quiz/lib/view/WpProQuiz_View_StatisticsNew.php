...
tr:hover .wpProQuiz_actions {
	...
	<div class="wrap wpProQuiz_statisticsNew">
		...
		<h1><?php echo sprintf( esc_html_x('%1$s: %2$s - Statistics', 'placeholders: Quiz, Quiz Name/Title', 'learndash'), LearnDash_Custom_Label::get_label( 'quiz' ), $this->quiz->getName()); ?></h1>
		<br>		
				...
				<div class="postbox">
					...
					<div class="inside">
						<ul>
							<li>
								<label>
									<?php echo sprintf( esc_html_x('Show only users, who solved the %s:', 'Show only users, who solved the quiz:', 'learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
