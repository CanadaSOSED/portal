			...
			if ( $this->post_type_check( $post_type ) ) {
				...
				if ( true === apply_filters( 'learndash_show_quiz_builder', $this->use_quiz_builder ) ) {
					...
					if ( ( isset( $data_settings['last_run'] ) ) && ( ! empty( $data_settings['last_run'] ) ) ) {
						...
						$quiz_questions_data_upgrade_link = '<a target="_blank" style="font-size: 100%; float: right;" href="'. $admin_url .'">'. sprintf(
					...
					add_meta_box(
						...
						sprintf(
							...
							esc_html_x( 'LearnDash %s Builder', 'Quiz Builder', 'learndash' ),
							LearnDash_Custom_Label::get_label( 'quiz' )
						) . $quiz_questions_data_upgrade_link,
				...
				add_meta_box(
					...
					// translators: placeholder: Quiz.
					sprintf( esc_html_x( 'LearnDash %s Question Settings', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
					array( $this, 'quiz_question_options_page_box' ),
					$this->post_type,
					'normal',
					'high'
				);
				...
				add_meta_box(
					...
					// translators: placeholder: Quiz.
					sprintf( esc_html_x( 'LearnDash %s Result Settings', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
					array( $this, 'quiz_result_options_page_box' ),
					$this->post_type,
					'normal',
					'high'
				);
				...
				add_meta_box(
					...
					// translators: placeholder: Quiz.
					sprintf( esc_html_x( 'LearnDash %s Mode Settings', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
					array( $this, 'quiz_mode_options_page_box' ),
					$this->post_type,
					'normal',
					'high'
				);
				...
				add_meta_box(
					...
					// translators: placeholder: Quiz.
					sprintf( esc_html_x( 'LearnDash %s Result Text Settings', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
					array( $this, 'quiz_custom_result_text_page_box' ),
					$this->post_type,
					'normal',
					'high'
				);
				...
				add_meta_box(
					...
					// translators: placeholder: Quiz.
					sprintf( esc_html_x( 'LearnDash %s Template Settings', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
					array( $this, 'quiz_templates_page_box' ),
					$this->post_type,
					'normal',
					'high'
				);
				...
				add_meta_box(
					...
					// translators: placeholder: Quiz.
					sprintf( esc_html_x( 'LearnDash %s Leaderboard Settings', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
					array( $this, 'quiz_leaderboard_options_page_box' ),
					$this->post_type,
					'normal',
					'high'
				);
				...
				add_meta_box(
					...
					// translators: placeholder: Quiz.
					sprintf( esc_html_x( 'LearnDash %s Custom Fields Settings', 'placeholder: Quiz', 'learndash' ), LearnDash_Custom_Label::get_label( 'quiz' ) ),
					array( $this, 'quiz_custom_fields_options_page_box' ),
					$this->post_type,
					'normal',
					'high'
				);
