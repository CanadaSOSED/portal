...
<!--END - CUSTOMIZATION MULTISITE REPORT-->
						...
						<div class="col-sm-3 ic_pink_skin">
							<div class="ic_block">
								<span class="ic_refresh_icon"><i class="fa fa-refresh"></i></span>
								...
								<div class="ic_block_content">
									<div class="ic_stat">
										<h4><?php _e('ORD. COUNT','icwoocommerce_textdomains');?></h4>
										<span class="taxreceived_count"></span>
									</div>

									<div class="ic_stat">
										<h4><?php _e('AMOUNT','icwoocommerce_textdomains');?></h4>
										<span class="ic_text taxreceived_amount"></span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-3 ic_purple_skin">
							<div class="ic_block">
								...
								<div class="ic_block_content">
									<div class="ic_stat">
										<h4><?php _e('ORD. COUNT','icwoocommerce_textdomains');?></h4>
										<span class="taxpaid_count"></span>
									</div>

									<div class="ic_stat">
										<h4><?php _e('AMOUNT','icwoocommerce_textdomains');?></h4>
										<span class="ic_text taxpaid_amount"></span>
									</div>
								</div>
							</div>
						</div>
...
<!--ismara - adding Session type and removing top countries-->
					<div class="row">
						<div class="col-md-12">
							<div class="ic_box">
								<div class="ic_box_header">
									<h3><?php _e('Top Session Types','icwoocommerce_textdomains')?></h3>
								</div>
								<div class="ic_box_body">
									<div class="ic_table-responsive top_session_types_grid"></div>
								</div>
							</div>
						</div>
					</div>
...
//2018-04-18 - ismaraalvim - begin - adding new taxes
					$return['summary_boxes']['taxreceived_amount']				= '';
					$return['summary_boxes']['taxreceived_count']				= '';

					$return['summary_boxes']['taxpaid_amount']				= '';
					$return['summary_boxes']['taxpaid_count']				= '';
//2018-04-18 - ismaraalvim - end
...
//2018-04-17 - ismaraalvim - always working with gross sales
...
$return['total_sales_amount'] 			= $return['order_sales_amount'];
...
//-ismara - adding Session types
        ...
        /* END - CUSTOMIZATION MULTISITE REPORT */
				...
				//2018-04-18 - ismaraalvim - begin - adding new taxes
				$return['taxreceived_amount'] 					= 0;
				$return['taxreceived_count'] 					= 0;
...
//--ismara-end - session type
			...
			//2018-04-18 - ismaraalvim - begin - adding new taxes
			$return['summary_boxes']['taxreceived_amount']				= wc_price($return['taxreceived_amount']);
			$return['summary_boxes']['taxreceived_count']				= $count_prefix.$return['taxreceived_count'];

			$return['summary_boxes']['taxpaid_amount']				= wc_price($return['taxpaid_amount']);
