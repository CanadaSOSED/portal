        ...
        4: [function(t, e, a) {
            function i(t) {
                var e, a, i, n = t[0] / 255,
                    ...
                    s = Math.max(n, o, r),
                    d = s - l;
                return s == l ? e = 0 : n == s ? e = (o - r) / d : o == s ? e = 2 + (r - n) / d : r == s && (e = 4 + (n - o) / d), e = Math.min(60 * e, 360), e < 0 && (e += 360), i = (l + s) / 2, a = s == l ? 0 : i <= .5 ? d / (s + l) : d / (2 - s - l), [e, 100 * a, 100 * i]
            }
            ...
            function n(t) {
                var e, a, i, n = t[0],
                    ...
                    s = Math.max(n, o, r),
                    d = s - l;
                return a = 0 == s ? 0 : d / s * 1e3 / 10, s == l ? e = 0 : n == s ? e = (o - r) / d : o == s ? e = 2 + (r - n) / d : r == s && (e = 4 + (n - o) / d), e = Math.min(60 * e, 360), e < 0 && (e += 360), i = s / 255 * 1e3 / 10, [e, a, i]
            }
            ...
            function h(t) {
                ...
                a = s < .5 ? s * (1 + l) : s + l - s * l, e = 2 * s - a, n = [0, 0, 0];
                for (var d = 0; d < 3; d++) i = r + 1 / 3 * -(d - 1), i < 0 && i++, i > 1 && i--, o = 6 * i < 1 ? e + 6 * (a - e) * i : 2 * i < 1 ? a : 3 * i < 2 ? e + (a - e) * (2 / 3 - i) * 6 : e, n[d] = 255 * o;
                return n
            }
            ...
            function B(t) {
                var e, a, i, n, o = t[0],
                    r = t[1],
                    l = t[2];
                return o <= 8 ? (a = 100 * o / 903.3, n = 7.787 * (a / 100) + 16 / 116) : (a = 100 * Math.pow((o + 16) / 116, 3), n = Math.pow(a / 100, 1 / 3)), e = e / 95.047 <= .008856 ? e = 95.047 * (r / 500 + n - 16 / 116) / 7.787 : 95.047 * Math.pow(r / 500 + n, 3), i = i / 108.883 <= .008859 ? i = 108.883 * (n - l / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(n - l / 200, 3), [e, a, i]
            }
            ...
            e.exports = function(t) {
                ...
                t.defaults.bar = {
                    ...
                    getBarIndex: function(t) {
                        var e, a, i = 0;
                        for (a = 0; a < t; ++a) e = this.chart.getDatasetMeta(a), e.bar && this.chart.isDatasetVisible(a) && ++i;
                        return i
                    },
                ...
                t.defaults.line = {
                    ...
                    update: function(t) {
                        ...
                        for (g && (o = s.custom || {}, void 0 !== f.tension && void 0 === f.lineTension && (f.lineTension = f.tension), s._scale = h, s._datasetIndex = r.index, s._children = d, s._model = {
                                spanGaps: !!f.spanGaps && f.spanGaps,
                            ...
                            }, s.pivot()), i = 0, n = d.length; i < n; ++i) r.updateElement(d[i], i, t);
                        for (g && 0 !== s._model.tension && r.updateBezierControlPoints(), i = 0, n = d.length; i < n; ++i) d[i].pivot()
                    },
                    ...
                    calculatePointY: function(t, e, a, i) {
                        ...
                        if (u.options.stacked) {
                            for (n = 0; n < a; n++) o = s.data.datasets[n], r = s.getDatasetMeta(n), "line" === r.type && s.isDatasetVisible(n) && (o.data[e] < 0 ? h += o.data[e] || 0 : c += o.data[e] || 0);
                            return t < 0 ? u.getPixelForValue(h + t) : u.getPixelForValue(c + t)
                        }
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        for (t = 0, e = l.length; t < e; ++t) i = l[t], n = i._model, o = a.splineCurve(a.previousItem(l, t)._model, n, a.nextItem(l, t)._model, r.dataset._model.tension), n.controlPointPreviousX = o.previous.x, n.controlPointPreviousY = o.previous.y, n.controlPointNextX = o.next.x, n.controlPointNextY = o.next.y
                    },
                    draw: function(t) {
                        var a, i, n = this,
                            o = n.getMeta(),
                            r = o.data || [],
                            l = t || 1;
                        for (a = 0, i = r.length; a < i; ++a) r[a].transition(l);
                        for (e(n.getDataset(), n.chart.options) && o.dataset.transition(l).draw(), a = 0, i = r.length; a < i; ++a) r[a].draw()
                    },
                    setHoverStyle: function(t) {
        ...
        19: [function(t, e, a) {
            ...
            e.exports = function(t) {
                ...
                t.defaults.polarArea = {
                    ...
                    updateElement: function(t, a, i) {
                        for (var n = this, o = n.chart, r = o.chartArea, l = n.getDataset(), s = o.options, d = s.animation, u = (s.elements.arc, t.custom || {}, o.scale), c = e.getValueAtIndexOrDefault, h = o.data.labels, f = n.calculateCircumference(l.data[a]), g = (r.left + r.right) / 2, p = (r.top + r.bottom) / 2, m = 0, b = n.getMeta(), v = 0; v < a; ++v) isNaN(l.data[v]) || b.data[v].hidden || ++m;
                        var x = -.5 * Math.PI,
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function(a) {
                    ...
                    updateDatasets: function() {
                        ...
                        if (t.plugins.notify("beforeDatasetsUpdate", [i])) {
                            for (e = 0, a = i.data.datasets.length; e < a; ++e) i.getDatasetMeta(e).controller.update();
                ...
                t.DatasetController = function(t, e) {
                    ...
                    addElements: function() {
                        var t, e, a = this,
                            ...
                            n = a.getDataset().data || [],
                            o = i.data;
                        for (t = 0, e = n.length; t < e; ++t) o[t] = o[t] || a.createMetaData(i, t);
                    ...
                    buildOrUpdateElements: function() {
                        var t = this.getMeta(),
                            ...
                            i = e.length;
                        if (a < i) e.splice(a, i - a);
                        else if (a > i)
                            for (var n = i; n < a; ++n) this.addElementAndReset(n)
                    },
                    update: a,
                    draw: function(t) {
                        var a = t || 1;
            ...
            e.exports = function(t) {
                ...
                o.each = function(t, e, a, i) {
                    ...
                    if (o.isArray(t))
                        ...
                        var l = Object.keys(t);
                        for (r = l.length, n = 0; n < r; n++) e.call(a, t[l[n]], l[n])
                    }
                }, o.clone = function(t) {
                    var e = {};
                ...
                o.requestAnimFrame = function() {
                    ...
                    var s = r.length / 2;
                    if (s > a.length) {
                        for (var d = 0; d < s; d++) delete n[r[d]];
                        r.splice(0, s)
                    }
                    return l
                ...
                t.defaults.scale = {
                        ...
                        if (d ? i.width = a.isFullWidth() ? a.maxWidth - a.margins.left - a.margins.right : a.maxWidth : i.width = s ? b : 0, d ? i.height = s ? b : 0 : i.height = a.maxHeight, l.display && s && (d ? i.height += 1.5 * g : i.width += 1.5 * g), r.display && s) {
                            ...
                            if (d) {
                                ...
                                var D = a.maxWidth - i.width,
                                    A = r.mirror;
                                A ? v = 0 : v += a.options.ticks.padding, v < D ? i.width += v : i.width = a.maxWidth, a.paddingTop = u / 2, a.paddingBottom = u / 2
                            }
                        }
                    ...
                    getBasePixel: function() {
                        var t = this,
                            e = t.min,
                            a = t.max;
                        return t.getPixelForValue(t.beginAtZero ? 0 : e < 0 && a < 0 ? a : e > 0 && a > 0 ? e : 0)
                    },
                    draw: function(a) {
                        var i = this,
                            n = i.options;
        ...
        33: [function(t, e, a) {
            ...
            e.exports = function(t) {
                ...
                function a(t) {
                    ...
                    var l = 0,
                        s = 0;
                    for (e = 0, a - i.length; e < a; ++e) l += i[e], s += n[e];
                    return {
                ...
                t.defaults.global.tooltips = {
                    ...
                    update: function(t) {
                        ...
                        if (d.length) {
                            ...
                            var h = [],
                                f = a(d),
                                g = [];
                            for (e = 0, o = d.length; e < o; ++e) g.push(i(d[e]));
                    ...
                    drawTitle: function(t, e, a, i) {
                        ...
                        if (o.length) {
                            ...
                            var d, u;
                            for (d = 0, u = o.length; d < u; ++d) a.fillText(o[d], t.x, t.y), t.y += r + l, d + 1 === o.length && (t.y += e.titleMarginBottom - l)
                        }
                    },
                    ...
                    inRange: function(t, e) {
                        ...
                        if (i) {
                            for (var n = a.getAngleFromPoint(i, {
                                    x: t,
                                    y: e
                                }), o = n.angle, r = n.distance, l = i.startAngle, s = i.endAngle; s < l;) s += 2 * Math.PI;
                            for (; o > s;) o -= 2 * Math.PI;
                            for (; o < l;) o += 2 * Math.PI;
                            var d = o >= l && o <= s,
        ...
        37: [function(t, e, a) {
            ...
            e.exports = function(t) {
                ...
                e.elements.rectangle = {
                    ...
                    inRange: function(t, e) {
                        var a = this._view;
                        return !!a && (a.y < a.base ? t >= a.x - a.width / 2 && t <= a.x + a.width / 2 && e >= a.y && e <= a.base : t >= a.x - a.width / 2 && t <= a.x + a.width / 2 && e >= a.base && e <= a.y)
                    },
                    inLabelRange: function(t) {
                        var e = this._view;
                ...
                var e = t.helpers,
                    ...
                    i = t.Scale.extend({
                        determineDataLimits: function() {
                            ...
                            var a;
                            void 0 !== t.options.ticks.min && (a = e.indexOf(t.chart.data.labels, t.options.ticks.min), t.minIndex = a !== -1 ? a : t.minIndex), void 0 !== t.options.ticks.max && (a = e.indexOf(t.chart.data.labels, t.options.ticks.max), t.maxIndex = a !== -1 ? a : t.maxIndex), t.min = t.chart.data.labels[t.minIndex], t.max = t.chart.data.labels[t.maxIndex]
                        },
                        ...
                        getValueForPixel: function(t) {
                            var e, a = this,
                                ...
                                r = o / i;
                            return a.options.gridLines.offsetGridLines && (t -= r / 2), t -= n ? a.paddingLeft : a.paddingTop, e = t <= 0 ? 0 : Math.round(t / r)
                        }
                    });
                            ...
                            if (a.min = null, a.max = null, i.stacked) {
                                ...
                                e.each(r, function(o, r) {
                                    ...
                                    n.isDatasetVisible(r) && t(l) && e.each(o.data, function(t, e) {
                                        ...
                                        isNaN(n) || l.data[e].hidden || (c[e] = c[e] || 0, h[e] = h[e] || 0, i.relativePoints ? c[e] = 100 : n < 0 ? (u = !0, h[e] += n) : (d = !0, c[e] += n))
                                    })
                                }), e.each(s, function(t) {
            ...
            e.exports = function(t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    ...
                    buildTicks: function() {
                        ...
                        for (var f = 1; f < h; ++f) o.push(u + f * l);
                                ...
                                if (e.each(t.ticks, function(r, l) {
                                    ...
                                    for (var g = t.getDistanceFromCenterForValue(i.reverse ? t.min : t.max), p = s(l.fontSize, a.defaultFontSize), m = s(l.fontStyle, a.defaultFontStyle), b = s(l.fontFamily, a.defaultFontFamily), v = e.fontString(p, m, b), x = t.getValueCount() - 1; x >= 0; x--) {
                                        ...
                                        var w = t.pointLabels,
                                            ...
                                            A = x < D || x > C - D,
                                            I = x === D || x === C - D;
                                        0 === x ? d.textAlign = "center" : x === M ? d.textAlign = "center" : x < M ? d.textAlign = "left" : d.textAlign = "right", I ? d.textBaseline = "middle" : A ? d.textBaseline = "bottom" : d.textBaseline = "top", d.fillText(w[x] ? w[x] : "", k.x, k.y)
                                    }
                                }
                            }
                        }
